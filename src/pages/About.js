    ...
    <div>
      <div className="NonWelcomeBlockBox">
        ...
        <div className="container AboutContent">
          ...
          Kaasaegse Rebaselinna Linnatransport asutati 90ndate lõpus. Meil on üks parimatest ühistranspordivõrgustik Euroopas koos tehnilise kompetentsiga ja suurimate tööpindadega. Rebaselinna Linnatransport on võtnud suuna muutuda teenindusettevõtteks. Rebaselinna Linnatranspordis ja meie inimestes võite alati kindel olla. Meie autobusside rattad veerevad 24/7 ja isegi kui maailm peatub, liigume ikka edasi.
        </div>
        <br />
        <div className="row">
